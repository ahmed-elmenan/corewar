...
int		ft_negative_nb_condition(t_list2 **lst, char *s, t_data1 *dt, char *tab)
{
...
int		ft_octal_sign_condition(t_list2 **list, char *str, t_data1 *data)
{
...
int		ft_plus_in_width_condition(t_list2 **lt, char *s, t_data1 *dt, char *r)
{
