...
char	*ft_handle_no_precision(t_list2 **lst, char *s, t_data1 *dt, char *p)
{
	char *tab;
...
char	*ft_add_hexa_prefix(t_list2 **list, t_data1 *data, char *tab)
{
	char *tmp;
...
char	*ft_handle_null_precision(t_list2 **lst, char *s, t_data1 *dt, char *s2)
{
	char *tab;
...
void	ft_ignore_sign(t_list2 **list, char *str, t_data1 *data, char **tab)
{
	data->p = str;
