...
void					ft_data1_initializer(t_data1 *data);
void					ft_list_initializer(t_list2 *tmp, t_data1 *data);
void					ft_conversion_builder(t_list2 *tmp, t_data1 *data);
void					ft_detect_asterisk(t_list2 *tmp, t_data1 *data);
void					ft_print_no_type(const char *format, t_data1 *data);
void					ft_printf_process(t_list2 *tmp, t_data1 *data);
void					ft_param(t_list2 *tmp, t_data1 *data);
void					ft_detect_precision(t_list2 **list, char **tab,
							char *str, t_data1 *data);
...
void					ft_print_string(t_list2 **list,
							char *tab, t_data1 *data);
void					ft_ignore_sign(t_list2 **list, char *str,
							t_data1 *data, char **tab);
...
int						ft_size_t_length_detected(t_data1 *data, int *i);
int						ft_ignore_space(t_data1 *data, int *i);
char					ft_check_cnv(const char *format, int i, t_data1 *data);
void					ft_detect_modifier(char const *format, int *i,
							t_data1 *data);
void					ft_check_space_d(t_data1 *data, int *i);
...
char					*ft_handle_nan(t_data1 *data);
