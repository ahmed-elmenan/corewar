...
/*   Updated: 2021/03/25 16:39:08 by ahel-men         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_detect_precision(t_list2 **list, char **tab, char *str,
			t_data1 *data)
{
	if ((*list)->cnv == 'c')
	{
...
void	ft_detect_space_d(t_list2 **list, char *str, t_data1 *data)
{
...
void	ft_detect_hash(t_list2 **list, char *str, t_data1 *data, int x)
{
