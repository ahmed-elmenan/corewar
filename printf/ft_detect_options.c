...
/*   Updated: 2020/02/07 01:46:40 by ahel-men         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	ft_detect_plus(t_list2 **list, char *tab, char *str, t_data *data)
{
...
void	ft_detect_minus(t_list2 **list, char *tab, char *str, t_data *data)
{
...
void	ft_detect_width(t_list2 **list, char *tab, char *str, t_data *data)
{
	data->y = -1;
...
void	ft_detect_negative_nb(t_list2 **lst, char *tab, char *s, t_data *dt)
{
...
void	ft_print_string(t_list2 **list, char *tab, t_data *data)
{
	if ((*list)->cnv != 'c')
	{
