...
/*   Updated: 2020/02/07 03:27:06 by ahel-men         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

char	*ft_handle_s_precision(t_list2 **list, char *str, t_data *data)
{
	char *tab;
...
char	*ft_handle_zero_null_precision(t_list2 **list, t_data *data)
{
	char *tab;
...
char	*ft_handle_nb_null_precision(t_list2 **l, char *s, t_data *dt, char *s2)
{
	char *tab;
...
char	*ft_handle_less_precision(t_list2 **list, t_data *data, char *p)
{
	char *tab;
...
char	*ft_handle_greather_precision(t_list2 **l, t_data *d, char *p, char *s2)
{
	char	*tab;
	char	*tmp;
	int		var;
